...
The project is a properly-licensed, metadata-complete Python distribution — building cleanly into an installable sdist/wheel that exposes the CLI, hosted in a public GitHub repository on a `main` branch, and published to PyPI.
